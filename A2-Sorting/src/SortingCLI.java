...
public class SortingCLI {
	...
	public void run() throws IOException {
		...
		if(sort == 1) {
			sortArray = array.getAscArray();
		}
		else if (sort == 2) {
			sortArray = array.getDesArray();
		}
		
		else if (sort == 3) {
			sortArray = array.getIntArray();
		}
		else {
			reader.display("Try Again");
		}
//		long endreg = System.currentTimeMillis();
//		reader.display("Bubble Sorting Time for " + size + " Item array " + " Sorted in " + sort + " order: " + (endreg - startreg) + " ms\n");
//		
...
//		writer.close();
		...
		if(type == 1) {
			...
			reader.display("Bubble Sorting Time for " + size + " Item array " + " Sorted in " + sort + " order: " + (endb - startb) + " ms\n");
			...
			reader.display("Insertion Sorting Time for " + size + " Item array " + " Sorted in " + sort + " order: " + (endi - starti) + " ms\n");
			...
			reader.display("Quick Sorting Time for " + size + " Item array " + " Sorted in " + sort + " order: " + (endq - startq) + " ms\n");
			...
			reader.display("Merge Sorting Time for " + size + " Item array " + " Sorted in " + sort + " order: " + (endm - startm) + " ms\n");
